/*@ngInject;*/
const ActionCableSocketWrangler = function($rootScope, ActionCableWebsocket, ActionCableConfig, ActionCableController) {
...
export default ActionCableSocketWrangler;
